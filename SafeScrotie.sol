...
/**
 * Tokenomics: (can be changed/removed, added everything that would possibly be needed to work with)
 * 
 * Liquidity        5%
 * Redistribution   4%
 * Burn             1%
...
import "./SafeScrotie-imports.sol";

/**
 * You should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `SafeScrotie` at the very bottom **and** the `environment` into which
 * you are deploying the contract `SafeScrotie(Env.Testnet)` or `SafeScrotie(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "SafeScrotie";
    string internal constant SYMBOL = "Scrotie";
    ...
    /**
     * Set the maximum transaction amount allowed in a transfer.
     * 
    ...
    /**
     * Set the maximum allowed balance in a wallet.
     * 
    ...
    /**
     * To add/edit/remove fees scroll down to the `addFees` function below
     */

    address internal charityAddress = 0x0000000000000000000000000000000000000000;
    address internal marketingAddress = 0x0000000000000000000000000000000000000000;

    /**
     * You can change the value of the burn address to pretty much anything
    ...
    /**
     * You can disable this but if you feel generous I'd appreciate the 0.1%
     * donation for making everyone's life a little easier.
     */
    address internal tipToTheDev = 0xf6E70f1741594e58A9A80A07C773F9b29aCAF5d3;
    ...
    function _addFees() private {
        ...
        // 0.1% as a tip to the dev; feel free to remove this! Just change value to zero. Scrotie Loves You!
...
abstract contract SafeScrotie is BaseRfiToken, Liquifier, Antiwhale {
    ...
    /**
     * When implemented this will convert the fee amount of tokens into ETH/BNB
...
contract SafeScrotie is SafeScrotie{

    constructor() SafeScrotie(Env.Testnet){
